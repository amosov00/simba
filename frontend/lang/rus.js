export default (context) => {
  const locale = {
    ...
    exchange: {
      ...
      suspended_help_text: 'не может быть отправлен, пожалуйста повысте ваш уровень верификации и свяжитесь с поддержкой',
    ...
    wallet: {
      ...
      address_failed_to_add_p2sh: 'Поддерживаются только P2SH адреса',
      ...
      new_btc_wallet_instruct: {
        text0: 'Поддерживаются только P2SH адреса',
