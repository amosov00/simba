export default context => {
  const locale = {
    ...
    account_page: {
      ...
      two_factor_modal: {
        step1: {
          title: '1. Установите OTP приложение (мы рекомендуем Google Authenticator).',
        ...
        step2: {
          title: '2. Внимание!',
          subtitle: 'Код на 3-ем шаге должен быть сохранен для восстановления доступа к вашей личной учетной записи, если вы потеряете свое доступ к устройству или приложению которое генерирует одноразовые пароли.'
        },
        step3: {
