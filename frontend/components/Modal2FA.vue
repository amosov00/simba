      ...
      <div class="two-fa-step">
        ...
        <div class="is-flex align-items-center">
          ...
          <div class="two-fa-step__backup">
            ...
            <div class="is-uppercase has-text-weight-bold black">
              {{ $t('account_page.two_factor_modal.attention') }}
            </div>
          </div>
        </div>
      </div>
      <div class="two-fa-step">
        ...
        <ValidationObserver tag="div" ref="form_pincode">
          <ValidationProvider
            ...
            v-slot="{ errors }"
            :name="$i18n.t('account_page.two_factor_modal.six_digit_code')"
            tag="div"
          >
            <div class="is-flex align-items-center">
              <input
                v-model="confirm2faData.pin_code"
                type="text"
                maxlength="6"
                class="smb-input mr-2"
                :placeholder="$i18n.t('account_page.two_factor_modal.six_digit_code')"
              />
